...
public class ProductOfAllOther {
    ...
    public static int[] getProductsOfAllIntsExceptAtIndex(int[] arr) {
        ...
        if (arr.length < 2) {
        throw new IllegalArgumentException("Getting the product of numbers requires at least 2 numbers");
        }
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(ProductOfAllOther.class);
